...
const I18n = {
  strings: {
    ...
    'insight.optimal': 'الـ Ankle بتاعك أرقامه ممتازة في كل الاختبارات. الـ Stability، الثقة، والقدرة البدنية جاهزين تماماً للملعب.\n\nده مش معناه إنك توقف شغل — الرياضيين اللي بيكملوا من غير إصابات هما اللي بيخلوا الـ Reactive Stability جزء من تمرينة الـ Warm-up بتاعتهم.\n\nكمل في التمارين اللي بتعمل Challenge للـ Ankle عشان تحافظ على الـ Baseline ده.',
    ...
    'action.severe.1.desc': 'اقف على رجلك المصابة لمدة دقيقتين كل يوم — عيونك مفتوحة في الأول، وبعدين قفلها. ده بيرجع يبني الـ Proprioception اللي الـ Ankle فقده.',
